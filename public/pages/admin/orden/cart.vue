                                ...
                                <div class="panel panel-cart">
                                    ...
                                    <div class="panel-body cart-item" v-for="(orden, id_orden) of cartStore.data"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="prod-price col" data-content="Precio">
                                                <span class="cart-item-price">
                                                    <span>Bs. {{ orden.monto_minimo }}</span>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" id="numeroDocumento" class="form-control"
                                                                placeholder="CI" :value="user.data.numeroDocumento"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group ">
                                                            ...
                                                            <select name="country" id="inputExpedido"
                                                                class="form-control" :value="user.data.expedido"
                                                                disabled>
                                                                <option value="">
                                                                    -
                                                                </option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="date" name="fecha_nac" id="inputFecha_nac"
                                                                class="form-control" :value="user.data.fecha_nac"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" name="nombres" id="inputNombres"
                                                                ...
                                                                :value="user.data.nombres" autocomplete="off" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" name="paterno" id="inputPaterno"
                                                                ...
                                                                :value="user.data.paterno" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" name="materno" id="inputMaterno"
                                                                ...
                                                                :value="user.data.materno" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="summary-content content" v-if="cartStore.data.length > 0">
                                    <ul class="summary-list" id="recurring">
                                        ...
                                        <li class="list-item" id="recurringMonthly"
                                            ...
                                            <span class="item-value">Bs. {{ orden.monto_minimo }}</span>
                                        </li>
                                    </ul>
                                    <ul class="summary-list">
                                        <li class="list-item">
                                            <span class="item-name">Subtotal</span>
                                            <span class="item-value">Bs. {{ subTotal }} </span>
                                        </li>
                                    </ul>
                                    <ul class="summary-list">
                                        <li class="list-item">
                                            <span class="item-name">Comisión</span>
                                            <span class="item-value">Bs. {{ comision }} </span>
                                        </li>
                                    </ul>
                                </div>
...
const postOrder = async () => {
    try {
        const data = await useApiFetch('/orden', {
            method: 'POST',
            body: {
                descripcion: `CTA ${user.data.nombres} ${user.data.paterno} ${user.data.materno}`,
                ...
                ordenConcepto: [
                    {
                        id_concepto: cartStore.data[0].id,
                        cantidad: 1,
                        id_tipo_medida: 1,
